...
var instance *Bitcoin
var once sync.Once

/***************************************************/
func CreateBitcoin(config *exchange.Config) *Bitcoin {
	once.Do(func() {
		instance = &Bitcoin{
			ID:      DEFAULT_ID,
			Name:    "Bitcoin",
...
func (e *Bitcoin) GetID() int {
	return e.ID
}

func (e *Bitcoin) GetName() exchange.ExchangeName {
	return exchange.BITCOIN
}

func (e *Bitcoin) GetTradingWebURL(pair *pair.Pair) string {
	return fmt.Sprintf("https://www.blank.com/marker/%s_%s", e.GetSymbolByCoin(pair.Target), e.GetSymbolByCoin(pair.Base))
}

func (e *Bitcoin) GetBalance(coin *coin.Coin) float64 {
...
func (e *Bitcoin) GetCoinConstraint(coin *coin.Coin) *exchange.CoinConstraint {
...
func (e *Bitcoin) SetCoinConstraint(coinConstraint *exchange.CoinConstraint) {
	coinConstraintMap.Set(fmt.Sprintf("%d", coinConstraint.CoinID), coinConstraint)
}

func (e *Bitcoin) GetCoins() []*coin.Coin {
	coinList := []*coin.Coin{}
	keySort := []int{}
...
func (e *Bitcoin) GetCoinBySymbol(symbol string) *coin.Coin {
...
func (e *Bitcoin) GetSymbolByCoin(coin *coin.Coin) string {
...
func (e *Bitcoin) DeleteCoin(coin *coin.Coin) {
	coinConstraintMap.Remove(fmt.Sprintf("%d", coin.ID))
}

/*************** Pairs on the Exchanges ***************/
func (e *Bitcoin) GetPairConstraint(pair *pair.Pair) *exchange.PairConstraint {
...
func (e *Bitcoin) SetPairConstraint(pairConstraint *exchange.PairConstraint) {
	pairConstraintMap.Set(fmt.Sprintf("%d", pairConstraint.PairID), pairConstraint)
}

func (e *Bitcoin) GetPairs() []*pair.Pair {
	pairList := []*pair.Pair{}
	keySort := []int{}
...
func (e *Bitcoin) GetPairBySymbol(symbol string) *pair.Pair {
...
func (e *Bitcoin) GetSymbolByPair(pair *pair.Pair) string {
...
func (e *Bitcoin) HasPair(pair *pair.Pair) bool {
	return pairConstraintMap.Has(fmt.Sprintf("%d", pair.ID))
}

func (e *Bitcoin) DeletePair(pair *pair.Pair) {
	pairConstraintMap.Remove(fmt.Sprintf("%d", pair.ID))
}

/**************** Exchange Constraint ****************/
func (e *Bitcoin) GetConstraintFetchMethod(pair *pair.Pair) *exchange.ConstrainFetchMethod {
...
func (e *Bitcoin) UpdateConstraint() {
	e.GetCoinsData()
	e.GetPairsData()
}

/**************** Coin Constraint ****************/
func (e *Bitcoin) GetTxFee(coin *coin.Coin) float64 {
...
func (e *Bitcoin) CanWithdraw(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Bitcoin) CanDeposit(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Bitcoin) GetConfirmation(coin *coin.Coin) int {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return 0
	}
...
/**************** Pair Constraint ****************/
func (e *Bitcoin) GetFee(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Bitcoin) GetLotSize(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Bitcoin) GetPriceFilter(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
