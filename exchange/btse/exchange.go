...
/***************************************************/
func CreateBtse(config *exchange.Config) *Btse {
	once.Do(func() {
		instance = &Btse{
			ID:      DEFAULT_ID,
			Name:    "Btse",
...
func (e *Btse) GetID() int {
	return e.ID
}

func (e *Btse) GetName() exchange.ExchangeName {
	return exchange.BTSE
}

func (e *Btse) GetTradingWebURL(pair *pair.Pair) string {
	return fmt.Sprintf("https://btse.com/trade/%s_%s", e.GetSymbolByCoin(pair.Target), e.GetSymbolByCoin(pair.Base))
}

func (e *Btse) GetBalance(coin *coin.Coin) float64 {
...
func (e *Btse) GetCoinConstraint(coin *coin.Coin) *exchange.CoinConstraint {
...
func (e *Btse) SetCoinConstraint(coinConstraint *exchange.CoinConstraint) {
	coinConstraintMap.Set(fmt.Sprintf("%d", coinConstraint.CoinID), coinConstraint)
}

func (e *Btse) GetCoins() []*coin.Coin {
	coinList := []*coin.Coin{}
	keySort := []int{}
...
func (e *Btse) GetCoinBySymbol(symbol string) *coin.Coin {
...
func (e *Btse) GetSymbolByCoin(coin *coin.Coin) string {
...
func (e *Btse) DeleteCoin(coin *coin.Coin) {
	coinConstraintMap.Remove(fmt.Sprintf("%d", coin.ID))
}

/*************** Pairs on the Exchanges ***************/
func (e *Btse) GetPairConstraint(pair *pair.Pair) *exchange.PairConstraint {
...
func (e *Btse) SetPairConstraint(pairConstraint *exchange.PairConstraint) {
	pairConstraintMap.Set(fmt.Sprintf("%d", pairConstraint.PairID), pairConstraint)
}

func (e *Btse) GetPairs() []*pair.Pair {
	pairList := []*pair.Pair{}
	keySort := []int{}
...
func (e *Btse) GetPairBySymbol(symbol string) *pair.Pair {
...
func (e *Btse) GetSymbolByPair(pair *pair.Pair) string {
...
func (e *Btse) HasPair(pair *pair.Pair) bool {
	return pairConstraintMap.Has(fmt.Sprintf("%d", pair.ID))
}

func (e *Btse) DeletePair(pair *pair.Pair) {
	pairConstraintMap.Remove(fmt.Sprintf("%d", pair.ID))
}

/**************** Exchange Constraint ****************/
func (e *Btse) GetConstraintFetchMethod(pair *pair.Pair) *exchange.ConstrainFetchMethod {
...
func (e *Btse) UpdateConstraint() {
	e.GetCoinsData()
	e.GetPairsData()
}

/**************** Coin Constraint ****************/
func (e *Btse) GetTxFee(coin *coin.Coin) float64 {
...
func (e *Btse) CanWithdraw(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Btse) CanDeposit(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Btse) GetConfirmation(coin *coin.Coin) int {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return 0
	}
...
/**************** Pair Constraint ****************/
func (e *Btse) GetFee(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Btse) GetLotSize(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Btse) GetPriceFilter(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
