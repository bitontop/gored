...
var instance *Belfries
var once sync.Once

/***************************************************/
func CreateBelfries(config *exchange.Config) *Belfries {
	once.Do(func() {
		instance = &Belfries{
			ID:      DEFAULT_ID,
			Name:    "Belfries",
			Website: "https://www.Belfries.com/",
...
func (e *Belfries) InitData() error {
	switch e.Source {
...
func (e *Belfries) GetID() int {
	return e.ID
}

func (e *Belfries) GetName() exchange.ExchangeName {
	return exchange.BELFRIES
}

func (e *Belfries) GetTradingWebURL(pair *pair.Pair) string {
	return fmt.Sprintf("https://www.Belfries.com/marker/%s_%s", e.GetSymbolByCoin(pair.Target), e.GetSymbolByCoin(pair.Base))
}

func (e *Belfries) GetBalance(coin *coin.Coin) float64 {
...
func (e *Belfries) GetCoinConstraint(coin *coin.Coin) *exchange.CoinConstraint {
...
func (e *Belfries) SetCoinConstraint(coinConstraint *exchange.CoinConstraint) {
	coinConstraintMap.Set(fmt.Sprintf("%d", coinConstraint.CoinID), coinConstraint)
}

func (e *Belfries) GetCoins() []*coin.Coin {
	coinList := []*coin.Coin{}
	keySort := []int{}
...
func (e *Belfries) GetCoinBySymbol(symbol string) *coin.Coin {
...
func (e *Belfries) GetSymbolByCoin(coin *coin.Coin) string {
...
func (e *Belfries) DeleteCoin(coin *coin.Coin) {
	coinConstraintMap.Remove(fmt.Sprintf("%d", coin.ID))
}

/*************** Pairs on the Exchanges ***************/
func (e *Belfries) GetPairConstraint(pair *pair.Pair) *exchange.PairConstraint {
...
func (e *Belfries) SetPairConstraint(pairConstraint *exchange.PairConstraint) {
	pairConstraintMap.Set(fmt.Sprintf("%d", pairConstraint.PairID), pairConstraint)
}

func (e *Belfries) GetPairs() []*pair.Pair {
	pairList := []*pair.Pair{}
	keySort := []int{}
...
func (e *Belfries) GetPairBySymbol(symbol string) *pair.Pair {
...
func (e *Belfries) GetSymbolByPair(pair *pair.Pair) string {
...
func (e *Belfries) HasPair(pair *pair.Pair) bool {
	return pairConstraintMap.Has(fmt.Sprintf("%d", pair.ID))
}

func (e *Belfries) DeletePair(pair *pair.Pair) {
	pairConstraintMap.Remove(fmt.Sprintf("%d", pair.ID))
}

/**************** Exchange Constraint ****************/
func (e *Belfries) GetConstraintFetchMethod(pair *pair.Pair) *exchange.ConstrainFetchMethod {
...
func (e *Belfries) UpdateConstraint() {
	e.GetCoinsData()
	e.GetPairsData()
}

/**************** Coin Constraint ****************/
func (e *Belfries) GetTxFee(coin *coin.Coin) float64 {
...
func (e *Belfries) CanWithdraw(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Belfries) CanDeposit(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Belfries) GetConfirmation(coin *coin.Coin) int {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return 0
	}
...
/**************** Pair Constraint ****************/
func (e *Belfries) GetFee(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Belfries) GetLotSize(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Belfries) GetPriceFilter(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
