...
/***************************************************/
func CreateBilaxy(config *exchange.Config) *Bilaxy {
	once.Do(func() {
		instance = &Bilaxy{
			ID:      DEFAULT_ID,
			Name:    "Bilaxy",
			Website: "https://www.bilaxy.com/",
...
func (e *Bilaxy) GetID() int {
	return e.ID
}

func (e *Bilaxy) GetName() exchange.ExchangeName {
	return exchange.BILAXY
}
...
func (e *Bilaxy) GetCoinConstraint(coin *coin.Coin) *exchange.CoinConstraint {
...
func (e *Bilaxy) SetCoinConstraint(coinConstraint *exchange.CoinConstraint) {
	coinConstraintMap.Set(fmt.Sprintf("%d", coinConstraint.CoinID), coinConstraint)
}

func (e *Bilaxy) GetCoins() []*coin.Coin {
	coinList := []*coin.Coin{}
	keySort := []int{}
...
func (e *Bilaxy) GetCoinBySymbol(symbol string) *coin.Coin {
...
func (e *Bilaxy) GetSymbolByCoin(coin *coin.Coin) string {
...
func (e *Bilaxy) DeleteCoin(coin *coin.Coin) {
	coinConstraintMap.Remove(fmt.Sprintf("%d", coin.ID))
}

/*************** Pairs on the Exchanges ***************/
func (e *Bilaxy) GetPairConstraint(pair *pair.Pair) *exchange.PairConstraint {
...
func (e *Bilaxy) SetPairConstraint(pairConstraint *exchange.PairConstraint) {
	pairConstraintMap.Set(fmt.Sprintf("%d", pairConstraint.PairID), pairConstraint)
}

func (e *Bilaxy) GetPairs() []*pair.Pair {
	pairList := []*pair.Pair{}
	keySort := []int{}
...
func (e *Bilaxy) GetPairBySymbol(symbol string) *pair.Pair {
...
func (e *Bilaxy) GetSymbolByPair(pair *pair.Pair) string {
...
func (e *Bilaxy) HasPair(pair *pair.Pair) bool {
	return pairConstraintMap.Has(fmt.Sprintf("%d", pair.ID))
}

func (e *Bilaxy) DeletePair(pair *pair.Pair) {
...
func (e *Bilaxy) UpdateConstraint() {
	e.GetCoinsData()
	e.GetPairsData()
}

/**************** Coin Constraint ****************/
func (e *Bilaxy) GetTxFee(coin *coin.Coin) float64 {
...
func (e *Bilaxy) CanWithdraw(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Bilaxy) CanDeposit(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Bilaxy) GetConfirmation(coin *coin.Coin) int {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return 0
	}
...
/**************** Pair Constraint ****************/
func (e *Bilaxy) GetFee(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Bilaxy) GetLotSize(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Bilaxy) GetPriceFilter(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
